    ...
    <script type="text/javascript">
        ...
        $('.thread_reply_btn').on('click', function(){
            $('html, body').animate({
                scrollTop: $("#reply_form").offset().top -200
            }, 2000);
        ...
        $('.toggle').on('click',function(event){
            ...
            let icon       = $(this).parent().find('.eyeIcon');
        ...
        /*
        let passwordInput = document.getElementById('old-pw'),
        ...
        */
        ...
        $('#categoryList').on('init.dt', function() {
            $('.add-project')
        ...
        $(function () {
            var projTable = $("#categoryList").DataTable({
                "paging": true,
                "lengthChange": false,
                "searching": true,
                "ordering": true,
