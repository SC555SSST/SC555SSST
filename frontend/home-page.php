                    ...
                    <div class="forum-section-container clearfix">
                        ...
                        <div class="forum-items">
                            ...
                            <div class="forum-item active">
                                <div class="row">
                                    <div class="col-sm-2 col-md-1 forum-info">
                                        <span class="views-number">1216</span>
                                        <div>
                                            <small>Answers</small>
                                        </div>
                                    </div>
                                    <div class="col-sm-10 col-md-8 no-left-padding">                                        
                                        <a href="forum_post.html" class="forum-item-title">General Discussion</a>
                                        <div class="forum-sub-title">Talk about sports, entertainment, music, movies, your favorite color, talk about enything.music, movies, your favorite color, talk about enything</div>
                                        <div class="forum-category"><a href="">Vegetables</a></div>
                                    </div>
                                    
                                    <div class="col-sm-12 col-md-3 forum-item-author">
                            ...
                            <div class="forum-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 no-left-padding">                                        
                                        ...
                                        <div class="forum-sub-title">New to the community? music, movies, your favorite color, talk about enything Please stop by, say hi and tell us a bit about yourself.</div>
                        ...
                        <div class="cat-page-link-container pull-right">
