                        ...
                        <div className="question-form row">
                            ...
                            <form className="login-form col-md-9">
                                ...
                                <div className="form-group">
                                    ...
                                    <select required id="gender" name="gender" className="select form-control">
                                ...
                                <div className="form-group">
                                    ...
                                    <button onClick={this.togglePassword} type="button" className="eyeIcon fa fa-eye toggle"></button>
                                </div>

                                <div className="form-group">
                                    <label htmlFor="text" className="control-label">confirm password</label>
                                    <input required id="confirm_password" name="confirm_password" type="password" className="form-control"/>
                                    <button onClick={this.togglePassword} type="button" className="eyeIcon fa fa-eye toggle"></button>
                                </div>
