                        ...
                        <div class="question-form row">
                            ...
                            <form class="login-form col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled value="ddf12" id="username" name="username" type="text" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="select" class="control-label">Gender</label> 
                                    <select disabled id="gender" name="gender" class="select form-control">
                                ...
                                <div class="form-group">
                                    <label for="select" class="control-label">User badge</label> 
                                    <select id="user_badge" name="user_badge" class="select form-control">
